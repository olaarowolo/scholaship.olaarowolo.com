...
function validateName() {
  ...
  if (
    !name.match(/[a-zA-Z]{2,}\s[a-zA-Z]{1,}'?-?[a-zA-Z]{2,}\s?([a-zA-Z]{1,})?/)
  ) {
...
function SendMail() {
  ...
  xmlHttp.send("from_name="+params.from_name+"&email_id="+params.email_id+"&subject="+params.subject);

  //   emailjs
  //     .send("service_4ajtfo5", "template_ryff15a", params)
  //     .then(function (res) {
